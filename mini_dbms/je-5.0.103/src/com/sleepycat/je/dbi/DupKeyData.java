 ...
 * the data is always zero length and the key is a two-part key.  The 'key'
 * parameter in the API is the first part of the key.  The the 'data' parameter
 * in the API is the second part of the key.
 *
...
public class DupKeyData {
     ...
     */
    public static byte[] makePrefixKey(final byte[] key,
                                       final int keyOff,
                                       final int keySize) {
        ...
        public int compare(final byte[] twoPartKey1,
            ...
            if (btreeComparator == null) {
                keyCmp = Key.compareUnsignedBytes
                    (twoPartKey1, 0, keySize1,
                     twoPartKey2, 0, keySize2);
            } else {
            ...
            if (duplicateComparator == null) {
                ...
                System.arraycopy(twoPartKey1, keySize1,
                                 data1, 0, dataSize1);
                System.arraycopy(twoPartKey2, keySize2,
                                 data2, 0, dataSize2);
     ...
     */
    public static int
        compareMainKey(final byte[] keyBytes1,
