...
public enum CacheMode {
     ...
     * operation where this cache mode is specified.  The hotness of the
     * parent BIN (bottom internal node) for the record is changed to "most
     * recently used" as if {@code DEFAULT} were used.
     *
