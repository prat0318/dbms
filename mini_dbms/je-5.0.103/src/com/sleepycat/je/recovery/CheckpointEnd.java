...
public class CheckpointEnd implements Loggable {
    ...
    private long id;
    private final CleanerLogSummary cleanerLogSummary;
    ...
    public CheckpointEnd(String invoker,
                         ...
                         CleanerLogSummary cleanerLogSummary) {
        if (invoker == null) {
            this.invoker = "";
        } else {
        ...
        this.cleanerLogSummary = cleanerLogSummary;
    }
    ...
    public void writeToLog(ByteBuffer logBuffer) {
        ...
        cleanerLogSummary.writeToLog(logBuffer);
    }
    ...
    public void readFromLog(ByteBuffer logBuffer, int entryVersion) {
        ...
        if (entryVersion >= 8) {
            cleanerLogSummary.readFromLog(logBuffer, entryVersion);
        }
    }
    ...
    public void dumpLog(StringBuilder sb, boolean verbose) {
        ...
        cleanerLogSummary.dumpLog(sb, verbose);
    ...
    public String toString() {
        ...
        sb.append(" cleanerLogSummary=").
           append(cleanerLogSummary.toString());
        return sb.toString();
    }
    ...
    public CleanerLogSummary getCleanerLogSummary() {
        return cleanerLogSummary;
    }
}
