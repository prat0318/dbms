...
public class LogUtils {
     ...
     *
     * TODO [#15296]  writeString, readString and getStringLogSize incorrectly
     * use the default encoding.  For JE 5.1, or whenever the file format
     * version is bumped to version 9, the following changes are needed:
     *  1) The two String.getBytes calls, in writeString and getStringLogSize,
     *     should pass UTF8 (defined in c.s.utilint.StringUtils).
     *  2) The readString method should pass UTF8 to the String ctor when
     *     entryVersion is GT 8, else continue to use the default encoding.
     * The log entry version tests should be enhanced to include a string with
     * non-ASCII chars, written by this method.
     *
     * Historical note:  See also [#20967] and [#15293].
     */
     ...
     *
     * @see #writeString TODO for JE 5.1.
     */
