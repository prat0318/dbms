 ...
 * Limitations
 * ===========
 * BINDeltas are all considered obsolete, as an implementation short cut and
...
public class UtilizationFileReader extends FileReader {
    ...
    protected boolean processEntry(ByteBuffer entryBuffer)
        ...
        if (entry instanceof LNLogEntry) {
            ...
            final boolean isActive = !lnEntry.isDeleted() &&
                                     dbImpl != null &&
    ...
    private boolean isINActive(INLogEntry<?> inEntry, DatabaseImpl dbImpl) {
        ...
        final SearchResult result = tree.getParentINForChildIN
            (logIn, true /*requireExactMatch*/, CacheMode.DEFAULT,
             logIn.getLevel(), null /*trackingList*/);
        ...
        try {
            ...
            /* The treeLsn may refer to a BINDelta. */
            final IN treeIn = (IN)
                result.parent.fetchTargetWithExclusiveLatch(result.index);
