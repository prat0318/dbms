 ...
 * 119MB.  To either of these amounts, at least 3MB (plus more for locks and
...
public class DbCacheSize {
    ...
    private void printProperties(final PrintStream out) {
        ...
        out.println("minInternalNodes=" + minBtreeSize);
        out.println("maxInternalNodes=" + maxBtreeSize);
        if (dataSize >= 0) {
            out.println("minAllNodes=" + minBtreeSizeWithData);
            out.println("maxAllNodes=" + maxBtreeSizeWithData);
        }
    }
