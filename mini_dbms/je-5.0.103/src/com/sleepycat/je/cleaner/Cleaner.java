...
public class Cleaner implements DaemonRunner, EnvConfigObserver {
        ...
        try {
            ...
            synchronized (protectedFileRanges) {
                ...
                if (!protectedFileRanges.isEmpty()) {
                    ...
                    unprotectedFiles = unprotectedFiles.headSet(minRangeStart);
                }
    ...
    void updateReadOnlyFileCollections() {
        ...
        final Set<Long> oldToBeCleaned = toBeCleanedFiles;
        final Set<Long> newToBeCleaned = fileSelector.getToBeCleanedFiles();
        toBeCleanedFiles = newToBeCleaned;
        checkBacklogGrowth(oldToBeCleaned.size(), newToBeCleaned.size());
    }

    /**
     * Use previous and current to-be-cleaned files to check backlog growth.
     * [#21111]
     * <p>
