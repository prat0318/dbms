...
public class CleanerStatDefinition {
    ...
    public static final StatDefinition CLEANER_PROBE_RUNS =
        new StatDefinition("nCleanerProbeRuns",
    ...
    public static final StatDefinition CLEANER_BIN_DELTAS_DEAD =
        new StatDefinition("nBINDeltasDead",
                           "Accumulated number of BINDeltas that were not " +
    ...
    public static final StatDefinition CLEANER_LN_SIZE_CORRECTION_FACTOR =
        new StatDefinition("lnSizeCorrectionFactor",
                           "The factor used to correct average LN size, for " +
                           "LNs whose obsolete size is not determined. " +
                           "Used to calculate corrected utilization.",
                           StatType.CUMULATIVE);
