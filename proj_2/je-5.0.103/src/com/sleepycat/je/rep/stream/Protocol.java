...
public class Protocol extends BinaryProtocol {
     ...
     *        entries
     */
    private Protocol(final RepNode repNode,
    ...
    public static Protocol get(final RepNode repNode,
                               final int protocolVersion) {
        return get(repNode, protocolVersion, LogEntryType.LOG_VERSION);
    }

    /**
     * Returns a protocol object that supports the specified protocol and
     * writes log entries in the specified log version format.
     */
    public static Protocol get(final RepNode repNode,
                               final int protocolVersion,
                               final int writeLogVersion) {
    ...
    static Protocol getProtocol(final RepNode repNode) {
        assert repNode != null;
        return new Protocol(repNode, VERSION, LogEntryType.LOG_VERSION);
    }
