...
public class ReplicatedEnvironmentStats implements Serializable {
     ...
     *
     * The total time in milliseconds spent between when an update operation
     * commits on the master and when it commits on the replica.  Note that the
     * accuracy of this value is affected by any clock skew between the master
     * and the replica.
     */
