 ...
 *     called for each key using a cursor scan.</li>
...
public interface SecondaryAssociation {
     ...
     * (EnvironmentImpl.getSecondaryAssociationLatch) exclusively.  All write
     ...
     * write operation.
     *
     * @throws RuntimeException if an unexpected problem occurs.  It will be
     * wrapped in an {@link EnvironmentFailureException} and thrown to the
     * application, causing the operation and transaction to be aborted.
     */
    boolean isEmpty();
