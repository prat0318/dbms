...
public class EnvironmentImpl implements EnvConfigObserver {
    ...
    protected EnvironmentImpl(File envHome,
        ...
        try {
            ...
            secondaryAssociationLatch =
                new SharedLatch("SecondaryAssociationLatch");
        ...
        try {
            if (ifBeforeLsn == DbLsn.NULL_LSN ||
                ...
                mapTreeRootLsn = logManager.log(
                    SingleItemEntry.create(LogEntryType.LOG_DBTREE,
                                           dbMapTree),
    ...
    public SharedLatch getSecondaryAssociationLatch() {
        return secondaryAssociationLatch;
    }
     ...
     * <p>
     * This implementation considers only files needed by Sync operations in
     * progress.
     *
    ...
    public SortedSet<Long> getUnprotectedFileSet(SortedSet<Long> files) {
        ...
        if (cleanerBarrierHoook != null) {
            return files.headSet(cleanerBarrierHoook.getHookValue());
        }

        long syncStart = syncCleanerBarrier.getMinSyncStart();
        return (syncStart == LogChangeSet.NULL_POSITION) ?
            files :
            files.headSet(DbLsn.getFileNumber(syncStart));
    }
