...
public class DbTree implements Loggable {
    ...
    private DatabaseImpl doCreateDb(Locker nameLocker,
        ...
        try {
            ...
            nameCursor.putLN(StringUtils.toUTF8(databaseName),   // key
                             nameLN,
                             null,                          // returnNewData
                             useRepContext);
    ...
    private DatabaseImpl doRenameDb(Locker locker,
        ...
        try {
            ...
            nameCursor.reset();
            nameCursor.putLN
                (StringUtils.toUTF8(newName), useLN, null /*returnNewData*/,
                 useRepContext);
    ...
    public DatabaseImpl getDb(Locker nameLocker,
        ...
        try {
            ...
            DatabaseEntry keyDbt =
                new DatabaseEntry(StringUtils.toUTF8(databaseName));
            boolean found =
                (nameCursor.searchAndPosition(keyDbt, SearchMode.SET,
                                              LockType.READ) &
                 CursorImpl.FOUND) != 0;
