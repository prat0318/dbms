...
public class MemoryBudget implements EnvConfigObserver {
    ...
    private final static int BIN_FIXED_OVERHEAD_64 = 512;
    private final static int BIN_FIXED_OVERHEAD_OOPS = 344;
    private final static int BIN_FIXED_OVERHEAD_DALVIK = 168; // TODO
    ...
    // 13
    private final static int IN_FIXED_OVERHEAD_32 = 336;
    private final static int IN_FIXED_OVERHEAD_64 = 439;
    private final static int IN_FIXED_OVERHEAD_OOPS = 295;
    private final static int IN_FIXED_OVERHEAD_DALVIK = 120; // TODO
